...
const starts = async (DogeXeonOP = new WAConnection()) => {
    ...
    console.log(color(figlet.textSync('KYURAZ Bot', {
		font: 'Standard',
...
console.log(color('> GITHUB: Vikoleonidas ','silver'))
...
console.log(color('  Xeon Bot Inc. 2022','mediumseagreen'))
    ...
    console.log(color('[KYURAZ BOT]'), color('Kyuraz Bot Is Online', 'aqua'))
    console.log(color('[DEV]', 'cyan'), color('Welcome Back Owner! Hope You Doing Well~', 'magenta'))
    console.log(color('<>','red'), color('Thanks For Using Kyuraz Bot', 'white'))
...
DogeXeonOP.on("group-participants-update", async (anu) => {
    ...
    try {
      ...
      try {
        ...
        DogeXeonOP.sendMessage(anu.jid, "Hello everyone, am Kyuraz Bot, ready to help you here ㋛︎", "conversation")
      }
      ...
      welcomeButt = { contentText: `${teks}`, footerText: ` 𝘽𝙤𝙩`, buttons: welcomeBut, headerType: 6, locationMessage: bosco2.message.locationMessage}
      ...
      goodbyeBut = [{buttonId:`#gbye`,buttonText:{displayText:'BYE '},type:1}, {buttonId:`#menu`,buttonText:{displayText:'MENU '}, type:1}]
      goodbyeButt = { contentText: `${out}`, footerText: ` 𝘽𝙤𝙩`, buttons: goodbyeBut, headerType: 6, locationMessage: bosco3.message.locationMessage}
